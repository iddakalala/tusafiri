...
if(empty ($plateNo) )
{
    ...
    //PREPARE SQL COMMAND
   $query = "SELECT `plate_number` FROM `tax` WHERE `plate_number`='$plateNo'";
  	...
  	
     {
     	...
     	if($query_num_rows==0)
     	{
     		$status= "<span style='color:red;'>namba ya taxi uliyoingiza si sahihi</span>";
                 		...
                 		$sql="SELECT * from  tax WHERE `plate_number`='$plateNo'";
 ...
 $query="UPDATE tax SET tax_name='$jina',plate_number='$plateNo',route_source='$source',route_destination='$destination',route_cost='$cost',route_status='$statusi' WHERE plate_number='$plateNo'";
...
<form action="updatetax.php" method="post">

<div id="search" style="margin:20px;">
	<label for="bno">Namba ya Tax:</label>
   ...
   <form action="" method="post" >
	            <table class="table table-condensed">
									   ...
									   <td> <input type="text" name="contact" id="contact"  value="<?php echo $contact; ?>" required></td>
										...
										<a href="tax.php" class="btn btn-primary">Rudi</a>
										</td>
										</tr>
	            </table>
