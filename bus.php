...
if(empty($name) or empty ($platenumber) or empty ($source) or empty ($destination)or empty ($cost)or empty ($contact)or empty ($statuss)or empty ($id)or empty ($via)or empty ($via))
{
  ...
  if($query_run= mysql_query($query))
  	
     {
     	...
     	if($query_num_rows==0)
     	{
     		$status= '<span style="color:red;"> tafadhali lipia kwanza upate id
     		</span>';
     	}else{
                 		$sql="INSERT INTO company(company_name,company_contact,company_id) VALUES ('$name','$contact','$id')";
                 		

     		$sql_command="INSERT INTO bus(bus_name,route_source,route_destination,route_via,platenumber,route_cost,route_status,company_id) VALUES ('$jina','$source','$destination','$via','$platenumber','$cost','$statuss','$id')";
 			...
 			$status5 ='<span style="color:blue;">umefanikiwa kutuma taarifa zako, karibu</span>';
     	}
     }
     	else{
		 ...
		 <p>karibu na ahsante kwa kuchangua website yetu kwa kujitangaza tumia Id  kujaza fomu<p>
			<div class="row">
				<div class="col-md-3">
			     ...
			     <p><a href="updatebus.php" class="btn btn-primary">Badilisha taarifa Ulizojaza</a></p>
				...
				<div class="col-md-8 col-md-push-1 col-sm-12 col-sm-push-0 col-xs-12 col-xs-push-0">
					<div class="row">
						<div class="col-md-6">
                                        ...
                                        <?php if(isset($status5))echo $status5;?>
