  ...
  if($query_run= mysql_query($query))
  	
     {
     	...
     	if($query_num_rows==0)
     	{
     		...
     		$sql_command="INSERT INTO bajaji(bajaji_name,route_source,route_destination,plate_number,route_cost,route_status,bajaji_contact) VALUES ('$name','$source','$destination','$platenumber','$cost','$statuss','$contact')";
  			  //SAVE TO DATABASE
		 ...
		 <p>karibu na ahsante kwa kuchangua website yetu kwa kujitangaza tumia Id  kujaza fomu<p>
			<div class="row">
				<div class="col-md-3">
			     ...
			     <p><a href="updatebajaji.php" class="btn btn-primary">Badilisha taarifa Ulizojaza</a></p>
				</div>
