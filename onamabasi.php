			...
			<div class="row">
				<div class="container">
					<div class="row">
						...
						<tbody>
							<?php 
                             $query="SELECT bus_name,platenumber,route_source,route_destination,route_via,route_cost,route_status,company.company_contact FROM bus,company WHERE (company.company_id=bus.company_id)";
