        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                 ...
                 <form action="processnews.php" enctype="multipart/form-data" method="post" class="form-horizontal"> 
                <div class="form-group">
                        <label for="title" class="label-horizontal col-sm-3">TITLE:</label>
                        <div class="col-sm-4">
                          <input type="text" name="title" id="title" class="form-control" placeholder="title" required="">
                        </div>
                    </div>
                        <div class="form-group">
                        <label for="contents" class="label-horizontal col-sm-3">contents:</label>
                        <div class="col-sm-4">
                          <textarea name="contents" id="contents" class="form-control" placeholder="contents">
                              
                          </textarea>
                        </div>
                    </div>
                        <div class="form-group">
                        <label for="fileuploaded" class="label-horizontal col-sm-3">Photo:</label>
                        <div class="col-sm-4">
                   ...
                   <?php
                    ...
                    {
                     echo "<strong><span style='color:green'>Successifully</span></strong>";   
